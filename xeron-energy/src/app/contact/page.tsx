...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Book your free solar site audit with Xeron Energy. Call +91 8320545680, WhatsApp us, or send an enquiry — serving Rajkot and all of Gujarat.",
};
...
const channels = [
  ...
  { icon: FiMail, label: "Email", value: site.email, href: site.emailHref },
];
  ...
  return (
    <>
      <PageHero
        ...
        description="Tell us a little about your property and a Xeron energy consultant will design your path to 70% lower bills — no cost, no obligation."
      />
              ...
              <GlassCard sheen={false} className="space-y-4">
                ...
                <div className="flex items-start gap-3 border-t border-white/8 pt-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-mist">Mon–Sat · 9:00 AM – 7:00 PM</p>
                  </div>
                </div>
              </GlassCard>
            </Reveal>
