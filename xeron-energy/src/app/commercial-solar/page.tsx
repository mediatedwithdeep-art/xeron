...
const data: SolutionData = {
  ...
  description:
    "Purpose-built rooftop and carport arrays for commercial properties. Cut operating costs, hedge against tariff hikes and demonstrate real sustainability leadership.",
  metrics: [
    { value: 40, suffix: "%", label: "Avg. OPEX cut" },
    { value: 250, suffix: " kW", label: "Typical system" },
    { value: 4, suffix: " yr", label: "Typical payback" },
    { value: 25, suffix: " yr", label: "Asset life" },
  ],
  overviewTitle: (
    <>
