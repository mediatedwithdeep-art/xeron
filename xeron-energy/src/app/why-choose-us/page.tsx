...
export const metadata: Metadata = {
  title: "Why Choose Us",
  description:
    "Why Gujarat chooses Xeron Energy: 18 years of government-sector engineering, in-house certified crews, Tier-1 components, lifetime monitoring and radical transparency.",
};
...
const comparison = [
  ...
  { point: "24×7 lifetime remote monitoring", xeron: true, others: false },
  { point: "Guaranteed generation (PLF) contracts", xeron: true, others: false },
  ...
  return (
    <>
      <PageHero
        ...
        description="Anyone can bolt panels to a roof. Xeron engineers plants that generate, endure and pay you back — with accountability that lasts decades."
      >
      ...
      <section className="relative py-16 md:py-24">
        <div className="container-x">
          <SectionHeading
            ...
            title={<>Xeron vs. <span className="text-aurora">the typical installer</span></>}
          />
